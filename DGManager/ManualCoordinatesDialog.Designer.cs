namespace DGManager
{
  partial class ManualCoordinatesDialog
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
		 ...
		 this.checkBox1.Text = "Space the photos out around the central point slightly (if several photos were se" +
			  "lected)";
		 ...
		 this.button3.Text = "Select Location On Map";
		 ...
		 this.Name = "ManualCoordinatesDialog";
		 this.ShowIcon = false;
		 this.ShowInTaskbar = false;
		 this.Text = "Please Manually Enter Coordinates";
