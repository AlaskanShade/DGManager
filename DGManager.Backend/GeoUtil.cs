...
namespace DGManager.Backend
{
    ...
    {
		#region Paths
		public static PointOfInterestList DownloadPath(string start, string end)
		{
            using (System.Net.WebClient wc = new System.Net.WebClient())
            {
                string xml = wc.DownloadString(String.Format("http://maps.google.com/maps?output=js&saddr={0}&daddr={1}&btnG=Search&sll=52.819363%2C-108.198853&sspn=0.765162%2C1.458435&z=8&t=null&f=d&hl=en", start.Replace(" ", "%20"), end.Replace(" ", "%20")));
                //http://maps.google.com/maps?f=d&source=s_d&saddr=salt+lake+city,+ut&daddr=elko,+nv+to:newport,+or&hl=en&geocode=&mra=ls&vps=11&output=js&jsv=158b&sll=28.356973,-81.560794&sspn=0.005202,0.005246
                string points = ParsePath(xml);
                PointOfInterestList newPath = new PointOfInterestList();
                newPath.AddRange(DecodeLocations(points));
                return newPath;
            }
		}
		#endregion
