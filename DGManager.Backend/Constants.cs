...
namespace DGManager.Backend
{
	public class Constants
	{
        ...
        //public static string INI_LINECOLOURR = "LineColourR";
        //public static string INI_LINECOLOURG = "LineColourG";
        //public static string INI_LINECOLOURB = "LineColourB";
        //public static string INI_LINEWIDTH = "LineWidth";
        //public static string INI_LINEOPACITY = "LineOpacity";
        //public static string INI_SPECIFYLINECOLOUR = "SpecifyLineColour";
        //public static string INI_SPECIFYLINEWIDTH = "SpecifyLineWidth";
        //public static string INI_SPECIFYLINEOPACITY = "SpecifyLineOpacity";
        //public static string INI_DIFFERENTTRACKCOLOURS = "DifferentTrackColours";
